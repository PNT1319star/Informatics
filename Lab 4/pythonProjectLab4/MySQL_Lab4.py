...
# create_database_query = "CREATE DATABASE ourbook_application"
...
# Connect to the database ourbooks_app
connection = create_connection("localhost", "root", "admin", "ourbook_application")
...
insert_books = """ 
INSERT INTO 
    books (title, yearOfPublication, genre, author_id, publisher_id) 
VALUES 
    ('To Kill a Mockingbird', 1960, 'Fiction', 1, 1), 
    ('1984', 1949, 'Dystopian', 2, 2), 
    ('Pride and Prejudice', 1813, 'Romance', 3, 1), 
    ('The Great Gatsby', 1925, 'Classic', 4, 3), 
    ('Harry Potter and the Sorcerer', 1997, 'Fantasy', 5, 4); 
"""
execute_query(connection, insert_books)

create_reviews = """
INSERT INTO
    `reviews` (`comment`, `rating`, `book_id`, `user_id`)
VALUES
    ('A classic!', 5, 1, 1),
...
SELECT *
FROM reviews
WHERE book_id IN (SELECT id FROM books WHERE yearOfPublication > 1900);
"""
