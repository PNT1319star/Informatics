...
$creates_comments_table = "CREATE TABLE comments
    (id INT NOT NULL AUTO_INCREMENT,
    PRIMARY KEY (id),
    created DATE,
    author VARCHAR(255),
...
$create_tbl_comments = mysqli_query($link, $creates_comments_table);
...
$notes_data = array(
    ...
    array('Healthy Cooking', 'Learn how to prepare delicious and healthy meals at home.'),
...
$comments_data = array(
    array('John Doe', 'Great article! I learned a lot.', 1),
